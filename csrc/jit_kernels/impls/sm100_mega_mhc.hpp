...
static void sm100_mega_mhc(
    ...
    // NVCC 13's default register optimization spills in the normal H7168 FP8 path.
    deep_jit::cuda::CompilerOptions compiler_options;
    if (hidden == 7168 and mix_args.new_prev_mix == nullptr and norm_args.y_fp8 != nullptr)
        compiler_options.ptxas_register_usage_level = 4;
...
static void __instantiate_kernel() {{
    ...
    >);
        ...
        shared_sf_block_m), compiler_options);
