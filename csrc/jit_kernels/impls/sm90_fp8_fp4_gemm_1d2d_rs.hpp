...
class SM90FP8FP4Gemm1D2DRSG128Runtime final
    : public LaunchRuntime<SM90FP8FP4Gemm1D2DRSG128Runtime> {
public:
    struct Args {
        GemmDesc gemm_desc;
        GemmConfig gemm_config;
...
static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(&sm90_fp8_fp4_gemm_1d2d_rs_g128_impl<
        {},
        {}, {}, {},
        {},
        {}, {}, {},
